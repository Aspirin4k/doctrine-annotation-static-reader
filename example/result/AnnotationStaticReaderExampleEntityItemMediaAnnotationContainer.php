...
class AnnotationStaticReaderExampleEntityItemMediaAnnotationContainer
{
    ...
    public static function getAnnotations(): array
    {
        if (empty(self::$annotations)) {
            ...
            self::$annotations['class'][\Doctrine\ORM\Mapping\Table::class]->name = 'item_media';
            ...
            self::$annotations['property']['item'][\Doctrine\ORM\Mapping\ManyToOne::class]->inversedBy = 'media';
            ...
            self::$annotations['property']['url'] = [];

            $column = new \ReflectionClass(\Doctrine\ORM\Mapping\Column::class);
            self::$annotations['property']['url'][\Doctrine\ORM\Mapping\Column::class] = $column->newInstanceWithoutConstructor();
            self::$annotations['property']['url'][\Doctrine\ORM\Mapping\Column::class]->name = null;
            self::$annotations['property']['url'][\Doctrine\ORM\Mapping\Column::class]->type = 'string';
            self::$annotations['property']['url'][\Doctrine\ORM\Mapping\Column::class]->length = null;
            self::$annotations['property']['url'][\Doctrine\ORM\Mapping\Column::class]->precision = null;
            self::$annotations['property']['url'][\Doctrine\ORM\Mapping\Column::class]->scale = null;
            self::$annotations['property']['url'][\Doctrine\ORM\Mapping\Column::class]->unique = false;
            self::$annotations['property']['url'][\Doctrine\ORM\Mapping\Column::class]->nullable = false;
            self::$annotations['property']['url'][\Doctrine\ORM\Mapping\Column::class]->options = [];
            self::$annotations['property']['url'][\Doctrine\ORM\Mapping\Column::class]->columnDefinition = null;
