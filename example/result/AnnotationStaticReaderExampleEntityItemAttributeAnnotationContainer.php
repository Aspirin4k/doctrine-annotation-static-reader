...
class AnnotationStaticReaderExampleEntityItemAttributeAnnotationContainer
{
    ...
    public static function getAnnotations(): array
    {
        if (empty(self::$annotations)) {
            ...
            self::$annotations['class'][\Doctrine\ORM\Mapping\Table::class]->name = 'item_attribute';
            ...
            self::$annotations['property']['item'][\Doctrine\ORM\Mapping\ManyToOne::class]->inversedBy = 'attributes';
            ...
            self::$annotations['property']['value'] = [];

            $column = new \ReflectionClass(\Doctrine\ORM\Mapping\Column::class);
            self::$annotations['property']['value'][\Doctrine\ORM\Mapping\Column::class] = $column->newInstanceWithoutConstructor();
            self::$annotations['property']['value'][\Doctrine\ORM\Mapping\Column::class]->name = null;
            self::$annotations['property']['value'][\Doctrine\ORM\Mapping\Column::class]->type = 'string';
            self::$annotations['property']['value'][\Doctrine\ORM\Mapping\Column::class]->length = null;
            self::$annotations['property']['value'][\Doctrine\ORM\Mapping\Column::class]->precision = null;
            self::$annotations['property']['value'][\Doctrine\ORM\Mapping\Column::class]->scale = null;
            self::$annotations['property']['value'][\Doctrine\ORM\Mapping\Column::class]->unique = false;
            self::$annotations['property']['value'][\Doctrine\ORM\Mapping\Column::class]->nullable = false;
            self::$annotations['property']['value'][\Doctrine\ORM\Mapping\Column::class]->options = [];
            self::$annotations['property']['value'][\Doctrine\ORM\Mapping\Column::class]->columnDefinition = null;
